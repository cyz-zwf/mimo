  ...
  <div class="index-main">
    <div class="index-main-body">
      ...
      <mt-swipe :auto="4000" class="kk-swipe">
        ...
        <mt-swipe-item class="kk-swipe-img kk-two">
          <div class="kk-text">
            <span>抢手热门房源</span>
            <span>领取精属房源专属券</span>
          </div>
        </mt-swipe-item>
        <mt-swipe-item class="kk-swipe-img kk-three">
          <div class="kk-text">
            <span>国外热门房源</span>
            <span>美国一号公路自驾游</span>
          </div>
      ...
      <div class="choose-wrapper">
        ...
        <div class="date-container">
          <div class="data-today">
            <span class="today-value">08月31日</span>
          ...
          <div class="data-tomorrow">
            <span class="today-value">09月1日</span>
...
.kk-swipe-img .kk-text span {
  display: block;
}
.kk-swipe-img .kk-text span:first-child {
  font-size: 12px;
  padding-bottom: 3px;
}
.kk-swipe-img .kk-text span:last-child {
  font-size: 22px;
}
/* 搜索框 */
...
.location-container .located-area {
  line-height: 20px;
  position: relative;
}
.selected-area i {
